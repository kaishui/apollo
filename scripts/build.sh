...
apollo_config_db_url='jdbc:mysql://192.168.31.198:3307/ApolloConfigDB?characterEncoding=utf8'
apollo_config_db_username='root'
apollo_config_db_password='jiulong'

# apollo portal db info
apollo_portal_db_url='jdbc:mysql://192.168.31.198:3307/ApolloPortalDB?characterEncoding=utf8'
apollo_portal_db_username='root'
apollo_portal_db_password='jiulong'
